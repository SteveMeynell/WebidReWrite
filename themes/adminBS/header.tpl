            ...
            <ul class="nav side-menu">
              ...
              <li><a><i class="fa fa-edit"></i> {L_5142} <span class="fa fa-chevron-down"></span></a>
                <ul class="nav child_menu" style="display: none">
                  <li> <a href="{SITEURL}admin/settings.php">{L_site_settings}</a></li>
				  <li> <a href="{SITEURL}admin/companysettings.php">{L_company_settings}</a></li>
				  ...
				  <li><a href="{SITEURL}admin/auctionreporting.php">{L_reporting_settings}</a></li>
          ...
          <ul class="nav navbar-nav navbar-right">
            <li class=""> <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false"> <img src="{SITEURL}themes/{THEME}/images/user.png" alt="">{ADMIN_USER} <span class=" fa fa-angle-down"></span> </a>
              <ul class="dropdown-menu dropdown-usermenu animated fadeInDown pull-right">
				<li><a href="{SITEURL}" target="_blank"><i class="fa fa-eye pull-right"></i> View Site</a> </li>
